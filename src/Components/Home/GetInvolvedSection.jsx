    ...
    <section id="get_involved" className='bg_secondary'>
        <div className="container text_centered">
            <SectionHeadingTemplate
              ...
              paragraph={`Join us in shaping the future of pageantry. Whether you're ready to grace the stage, lend a helping hand, or partner with us, "Bold Blossoms" invites you to become a part of a movement that celebrates empowerment and beauty in every form.`}
            />
